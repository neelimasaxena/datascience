...
directory = "F:/NeelimaProjects/FaceDetectionVideoRec/expimages/Yawning/"

## directory where the images to be saved:
f_directory = "F:/NeelimaProjects/FaceDetectionVideoRec/cropedexpimages/Yawning/"

def facecrop(image):
    ## Crops the face of a person from any image!

    ## OpenCV XML FILE for Frontal Facial Detection using HAAR CASCADES.
    facedata = "F:/NeelimaProjects/FaceDetectionVideoRec/haarcascade_frontalface_alt.xml"
    ...
    try:
        ...
        for f in faces:
            ...
            cv2.imwrite(f_directory + 'Yawning_'+f_name, sub_face)
            print ("Writing: " + image)
